...
session = boto3.Session(profile_name='SnapshotList')
...
@click.group()
def cli():
    """SnapshotList Manages Snapshots"""
...
@click.option('--project', default=None,
    help="Only snapshotd for project (tag Project:<name>)")
